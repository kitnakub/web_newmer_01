...
const Forwardh: React.FC = () => {
  ...
  const forwardh = () => {
    ...
    switch (degree) {
      case 1:
        y = (func(fx, x + h) - func(fx, x)) / h;
        break;
      case 2:
        y = (func(fx, x) - 2*func(fx, x + h) + func(fx, x + 2*h)) / (h*h);
        break;
      case 3:
        y = (-func(fx, x) + 3*func(fx, x + h) - 3*func(fx, x + 2*h) + func(fx, x + 3*h)) / (h**3);
        break;
      case 4:
        y = (func(fx, x) - 4*func(fx, x + h) + 6*func(fx, x + 2*h) - 4*func(fx, x + 3*h) + func(fx, x + 4*h)) / (h**4);
        break;
      default:
